...
3. The current CUDA implementation is not optimized. The optimization pattern is nearly identical to *GEMM* optimizations, but it may take quite a lot time to make small adjustments to fit our needs.
