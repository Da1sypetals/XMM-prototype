...
class XmmFn(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        grad_x, grad_c1, grad_c2, grad_c3, grad_bias = op.backward(
            grad_output, x, c1, c2, c3, bias
        )
...
class XmmLayer(nn.Module):
    def __init__(self, in_features, out_features):
        ...
        nn.init.kaiming_uniform_(self.c1, a=(5**0.5))
        nn.init.kaiming_uniform_(self.c2, a=(5**0.5))
        nn.init.kaiming_uniform_(self.c3, a=(5**0.5))
