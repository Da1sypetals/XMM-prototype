...
__global__ void
fwd_kernel(const torch::PackedTensorAccessor64<float, 2> a_r1, const torch::PackedTensorAccessor64<float, 2> a_c1, const torch::PackedTensorAccessor64<float, 2> a_c2, const torch::PackedTensorAccessor64<float, 2> a_c3, torch::PackedTensorAccessor64<float, 2> a_result, int M, int N, int K, int numThreads)
{
    {
